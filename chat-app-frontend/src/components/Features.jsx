...
const Features = () => {
  ...
  // Theme-based classes
  const sectionBg = mode === "dark" ? "bg-gray-900" : "bg-[#F6F9FE]";
  const cardBg = mode === "dark" ? "bg-gray-800 border-gray-700" : "bg-white";
  const cardText = mode === "dark" ? "text-white" : "text-[#1B2559]";
  const subText = mode === "dark" ? "text-gray-400" : "text-[#4B5563]";
  const iconBg = mode === "dark" ? "bg-indigo-900" : "bg-[#2563eb]";
    ...
    <section className={`${sectionBg} transition-colors`}>
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="max-w-screen-md mb-8 lg:mb-16">
          ...
          <p className={` text-sm sm:text-lg ${subText}`}>
        ...
        <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          {/* Feature 1 */}
          <div className={`${cardBg} p-6 rounded-lg shadow ${cardText}`}>
            <div className={`flex justify-center items-center mb-4 w-10 h-10 rounded-full ${iconBg} lg:h-12 lg:w-12`}>
              <svg
                className={`w-5 h-5 lg:w-6 lg:h-6 ${iconText}`}
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
            ...
            <h3 className="mb-2 text-lg font-bold">Marketing</h3>
          ...
          <div className={`${cardBg} p-6 rounded-lg shadow ${cardText}`}>
            ...
            <h3 className="mb-2 text-lg font-bold">Business Automation</h3>
            <p className={`${subText} text-sm`}>
          ...
          <div className={`${cardBg} p-6 rounded-lg shadow ${cardText}`}>
            ...
            <h3 className="mb-2 text-lg font-bold">Finance & Audit</h3>
            <p className={`${subText} text-sm`}>
          ...
          <div className={`${cardBg} p-6 rounded-lg shadow ${cardText}`}>
            ...
            <h3 className="mb-2 text-lg font-bold">Enterprise Design</h3>
            <p className={`${subText} text-sm`}>
          ...
          <div className={`${cardBg} p-6 rounded-lg shadow ${cardText}`}>
            ...
            <h3 className="mb-2 text-lg font-bold">Operations</h3>
            <p className={`${subText} text-sm`}>
